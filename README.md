...
* Pour la detexction de sosus tours on applique un parcours en profondeur afin de calculer les composantes connexes et ainsi detecter les sous tours.
    ...
    * Lorsequ'un sous-tour est trouvé, on identifie le ssommets impliqués, on ajoute une contrainte qui force le sous-ensemble du sous-tour a avoir au moins 2 connexions avec son complément.
---
...
La première version de l'affiche a été faite car sa visualisation de la solution  est plus simple pour gérer les erreurs et déboguer qu'avec plusieurs étoiles.